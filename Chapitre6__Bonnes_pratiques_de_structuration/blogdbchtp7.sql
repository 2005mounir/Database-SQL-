...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 25 déc. 2025 à 11:06
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Table des articles du blog';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Table des commentaires des articles';
...
ALTER TABLE `commentaire`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_id_article` (`id_article`),
